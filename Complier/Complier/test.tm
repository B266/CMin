...
*-> Id (i)
 ...
 31:     ADD   0,5,0	id: calculate the address
...
*<- Const
 ...
 36:     ADD   0,1,0	op +
*<- Op
 37:     LD  1,-3(6) 	assign: load left (address)
...
*<- Const
 40:     ST  0,-5(6) 	call: push argument
 41:     LD  0,-5(6) 	load arg to ac
 42:     OUT   0,0,0	write ac
*<- Call
*<-compound
 43:     LDA 7,-30(7)	while: jmp back to test
 25:     JEQ 0,18(7)	while: jmp to end
*<- iter.
*<-compound
 44:     LD  7,-1(6) 	func: load pc with return address
  5:     LDA 7,39(7)	func: unconditional jump to next declaration
*-> Function (main)
 45:    LDC  0,-1(0) 	init: load globalOffset
 46:     ADD   6,6,0	init: initialize mp with globalOffset
*-> Call
 47:     ST  6,1(6) 	call: store current mp
 48:    LDA  6,0(6) 	call: push new frame
 49:    LDA  0,1(7) 	call: save return in ac
 50:    LDC  7,6(0) 	call: unconditional jump to main() entry
 51:     LD  6,1(6) 	call: pop current frame
*<- Call
*End of execution.
 52:    HALT   0,0,0	
