...
*-> assign
*-> Id (z)
 91:    LDC  0,-4(0) 	id: load varOffset
 92:     ADD   0,6,0	id: calculate the address found in current frame
 93:    LDA  0,0(0) 	load id address
*<- Id
 94:     ST  0,-5(6) 	assign: push left (address)
*-> Const
 95:    LDC  0,0(0) 	load const
*<- Const
 96:     LD  1,-5(6) 	assign: load left (address)
...
*-> Op
*-> Id (z)
 98:    LDC  0,-4(0) 	id: load varOffset
 99:     ADD   0,6,0	id: calculate the address found in current frame
100:     LD  0,0(0) 	load id value
*<- Id
101:     ST  0,-5(6) 	op: push left
*-> Const
102:    LDC  0,3(0) 	load const
*<- Const
103:     LD  1,-5(6) 	op: load left
104:     SUB   0,1,0	op <
105:    JLT  0,2(7) 	br if true
...
*-> assign
*-> Id (z)
110:    LDC  0,-4(0) 	id: load varOffset
111:     ADD   0,6,0	id: calculate the address found in current frame
112:    LDA  0,0(0) 	load id address
*<- Id
113:     ST  0,-5(6) 	assign: push left (address)
*-> Op
*-> Id (z)
114:    LDC  0,-4(0) 	id: load varOffset
115:     ADD   0,6,0	id: calculate the address found in current frame
116:     LD  0,0(0) 	load id value
*<- Id
117:     ST  0,-6(6) 	op: push left
*-> Const
118:    LDC  0,1(0) 	load const
*<- Const
119:     LD  1,-6(6) 	op: load left
120:     ADD   0,1,0	op +
*<- Op
121:     LD  1,-5(6) 	assign: load left (address)
122:     ST  0,0(1) 	assign: store value
*<- assign
*-> Call
*-> Id (z)
123:    LDC  0,-4(0) 	id: load varOffset
124:     ADD   0,6,0	id: calculate the address found in current frame
125:     LD  0,0(0) 	load id value
*<- Id
126:     ST  0,-7(6) 	call: push argument
127:     LD  0,-7(6) 	load arg to ac
128:     OUT   0,0,0	write ac
*<- Call
*<-compound
129:     LDA 7,-32(7)	while: jmp back to test
109:     JEQ 0,20(7)	while: jmp to end
*<- iter.
*<-compound
130:     LD  7,-1(6) 	func: load pc with return address
 59:     LDA 7,71(7)	func: unconditional jump to next declaration
* frameoffset (-8) 
131:    LDC  0,-2(0) 	init: load globalOffset
132:     ADD   6,6,0	init: initialize mp with globalOffset
*-> Call
133:     ST  6,0(6) 	call: store current mp
134:    LDA  6,0(6) 	call: push new frame
135:    LDA  0,1(7) 	call: save return in ac
136:    LDC  7,60(0) 	call: unconditional jump to main() entry
137:     LD  6,0(6) 	call: pop current frame
*<- Call
*End of execution.
138:    HALT   0,0,0	
